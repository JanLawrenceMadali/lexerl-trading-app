...
class CollectiblesSummaryExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    protected $startDate;
    protected $endDate;
    ...
    public function collection()
    {
        ...
        $collectiblesData = $collectibles->flatMap(function ($sale) use ($units) {
        ...
        $totalAmount = $collectibles->sum(function ($sale) {
    ...
    {
        return [
            ['Lexerl Trading Inc - Collectibles Summary Report'],

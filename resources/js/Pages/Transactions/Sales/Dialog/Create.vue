                            ...
                            <div class="grid items-center gap-3 md:grid-cols-2">
                                ...
                                <div class="grid items-center gap-3 md:text-right md:grid-cols-5">
                                    <Label class="col-span-2">
                                        <span
                                            class="after:content-['*'] after:ml-0.5 after:text-red-500">Customer</span>
                                    </Label>
                            ...
                            <div class="grid gap-3 md:grid-cols-2">
                                <div class="grid grid-cols-1 gap-3 md:gap-4">
                                    ...
                                    <div class="grid items-center gap-3 md:text-right md:grid-cols-5">
                                        ...
                                        <div class="relative items-center w-full md:col-span-3">
                                            <Input id="landed_cost" v-model="form.landed_cost" type="number" min=0 oninput="validity.valid||(value='');"

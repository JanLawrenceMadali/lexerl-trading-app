                                        ...
                                        : $page.component === 'Settings/Category/Index' ? 'bg-slate-100 text-slate-800'
                                            : $page.component === 'Settings/Subcategory/Index' ? 'bg-slate-100 text-slate-800'
                                                : $page.component === 'Settings/BackupDatabases/Index' ? 'bg-slate-100 text-slate-800'
                                                    : 'text-muted-foreground'">
                        <svg :class="['size-8 group-hover:fill-[#1B1212] group-hover:text-[#1B1212]',
                            $page.component === 'Settings/Users/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                $page.component === 'Settings/Units/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                    $page.component === 'Settings/Suppliers/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                        $page.component === 'Settings/Customers/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                            $page.component === 'Settings/Categories/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                                $page.component === 'Settings/Category/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                                    $page.component === 'Settings/Subcategory/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
                                                        $page.component === 'Settings/BackupDatabases/Index' ? 'fill-[#1B1212] text-[#1B1212]' :
